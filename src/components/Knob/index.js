...
export default class Knob extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = { deg: this.currentDeg, swiped: false };
  ...
  _onTouchMove(e) {
    if (e.changedTouches && e.changedTouches.length) {
      ...
      //console.log(touch);
      this.dx = Math.abs(touch.clientX - this.sx);
      this.dy = Math.abs(touch.clientY - this.sy);

      this.currentDeg = this.getDeg(touch.clientX, touch.clientY, this.tpts);
  ...
  render() {
    ...
    return (
      <div className="knob" style={kStyle}  >
        ...
        <div className="knob outer" style={oStyle} onMouseDown={this.startDrag} onTouchStart={this._onTouchStart}
