...
export default function ControlSidebar(props) {
  ...
  // const robotAutoRotate = useSelector((state) => getAutoRotateView(state));
          ...
          <div className="card-tools">
            ...
            <Form>
              ...
              <Form.Check
                  ...
                  id="show_tool_bar"
                  label="Show Toolbar"
                  defaultChecked={props.showToolbar}
                  onChange={() => {
                     props.onShowToolbar(!props.showToolbar);
                  }}
                />
                ...
                <Form.Check
                  type="switch"
                  id="robot_auto_rotate"
                  label="Robot auto rotate view"
                  defaultChecked={props.robotAutoView}
                  onChange={() => {
                    props.onRobotRotate(!props.robotAutoView);
                  }}
                />
